...
public class CenovnikActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cenovnici.add(new Cenovnik("Trening u teretani",1900,"https://body.ba/pictures/article/pages/1563272926-vjezbanje-poboljsava-mozdanu-funkciju.jpg"));
        cenovnici.add(new Cenovnik("SPA",2100,"https://lepotica.rs/wp-content/uploads/2020/08/Untitled-design214-660x400.png"));
        cenovnici.add(new Cenovnik("Athletic 360",2400,"https://www.ampyourworkout.com/wp-content/uploads/2016/06/GYM_Dumbells.png"));
